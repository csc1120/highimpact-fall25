...
public class TestStacksQueues {
    public static void testStack(PureStack<Integer> stack, int numValues){
    ...
    public static void main(String[] args) {
        ...
        testStack(listStack, 1_000);
//        ListQueue<Integer> listQueue = new ListQueue<>();
//        testQueue(listQueue, 1_000_000);

        PureStack<Integer> nodeStack = new NodeStack<>();
        testStack(nodeStack, 1_000);
    }
}
